...
import * as S from './styles/emailAndVerification.style'
...
const Onboarding = () => {
  ...
  return (
    <S.Onboarding>
      {/* Modal Header */}
      <S.HeaderContainer>
        <S.CloseButton onPress={() => dispatch({ type: 'TOGGLE_SIGN_IN_MODAL' })}>
      ...
      <S.BodyContainer>
        <Swiper loop={false}>
          ...
          <S.SlideContainer>
            ...
            <S.SignInButton onPress={() => dispatch({ type: 'TOGGLE_SIGN_IN_MODAL' })}>
